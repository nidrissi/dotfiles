...
** TODO État de frais" :time-prompt t)))
 ...
 '(recentf-exclude
   '("/home/najib/.config/emacs/elpa" "/\\(\\(\\(COMMIT\\|NOTES\\|PULLREQ\\|MERGEREQ\\|TAG\\)_EDIT\\|MERGE_\\|\\)MSG\\|\\(BRANCH\\|EDIT\\)_DESCRIPTION\\)\\'"))
