...
(custom-set-variables
 ...
 '(aw-keys (quote (38 233 34 39 40 45 232 95 231 224)))
 '(backup-by-copying t)
...
** TODO État de frais" :time-prompt t))))
 ...
 '(package-selected-packages
   (quote
    (web-mode use-package glsl-mode julia-repl tuareg julia-mode ebib graphviz-dot-mode ivy smart-mode-line json-mode go-mode ssh-agency tup-mode openwith-mode jade-mode sass-mode tide multiple-cursors diff-hl move-text gitconfig-mode gitignore-mode ivy-hydra counsel-projectile counsel anzu volatile-highlights-mode volatile-highlights smartparens company-emoji auctex-latexmk projectile-mode ace-jump-mode esup yaml-mode visual-fill-column unicode-fonts undo-tree smart-mode-line-powerline-theme rainbow-delimiters openwith markdown-mode magit diminish cperl-mode company browse-kill-ring auctex ace-window)))
